import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfInsuranceFSCISEPolicyRecordAlertCard extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`SingleAlert`,this._allMergeFields,this._regexPattern,"noparse");
